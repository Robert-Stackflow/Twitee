...
repo_path = "D:\\Repositories\\Twitee"
apks_path = "D:\\Repositories\\Twitee\\build\\app\\outputs\\flutter-apk"
windows_release_path = (
    "D:\\Repositories\\Twitee\\build\\windows\\x64\\runner\\Release"
)
downloads_path = "D:\\Ruida\\Downloads"
dll_path = "D:\\Repositories\\Twitee\\tools\\dll"
iss_path = "D:\\Repositories\\Twitee\\tools\\Twitee.iss"
    ...
    for root, dirs, files in os.walk(apks_path):
        for file in files:
            ...
            if match:
                ...
                if abi == "":
                    new_file = f"Twitee-{version}.apk"
                else:
                    new_file = f"Twitee-{version}-{abi}.apk"
...
def zip_windows(version):
    ...
    zip_path = os.path.join(get_downloads_path(version), "Twitee-" + version + ".zip")
