    ...
    switch (_source) {
      case _FontSource.asset:
        try {
          ...
          ILogger.error("Twitee", "Failed to load font asset", e, t);
          return false;
        }
      case _FontSource.file:
        ...
        try {
          ...
          ILogger.error("Twitee", "Failed to load font file", e, t);
          return false;
        }
      case _FontSource.url:
        try {
          ...
          ILogger.error("Twitee", "Failed to download font", e, t);
          return false;
        }
    }
  }
...
Future<Uint8List> downloadBytes(
  ...
  await response.stream.listen((List<int> chunk) {
    ...
    if (response.contentLength == null) {
      ILogger.info("Twitee", 'Download font: ${bytes.length} bytes');
    } else {
