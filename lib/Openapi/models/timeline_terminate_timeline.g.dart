...
_$TimelineTerminateTimelineImpl _$$TimelineTerminateTimelineImplFromJson(
...
Map<String, dynamic> _$$TimelineTerminateTimelineImplToJson(
        _$TimelineTerminateTimelineImpl instance) =>
    <String, dynamic>{
      'direction':
