...
_$ItemResultImpl _$$ItemResultImplFromJson(Map<String, dynamic> json) =>
    _$ItemResultImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
      result: TweetUnion.fromJson(json['result'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$ItemResultImplToJson(_$ItemResultImpl instance) =>
    <String, dynamic>{
