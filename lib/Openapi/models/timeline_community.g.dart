...
_$TimelineCommunityImpl _$$TimelineCommunityImplFromJson(
        Map<String, dynamic> json) =>
    _$TimelineCommunityImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
    );

Map<String, dynamic> _$$TimelineCommunityImplToJson(
        _$TimelineCommunityImpl instance) =>
    <String, dynamic>{
