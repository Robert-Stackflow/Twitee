...
class MediaVisibilityResults {
  ...
  factory MediaVisibilityResults.fromJson(Map<String, Object?> json) =>
      _$MediaVisibilityResultsFromJson(json);

  @JsonKey(name: 'blurred_image_interstitial')
  final MediaVisibilityResultsBlurredImageInterstitial?
