...
_$BirdwatchEntityRefImpl _$$BirdwatchEntityRefImplFromJson(
        Map<String, dynamic> json) =>
    _$BirdwatchEntityRefImpl(
      text: json['text'] as String,
      type: BirdwatchEntityRefType.fromJson(json['type'] as String),
      url: json['url'] as String,
      urlType: BirdwatchEntityRefUrlType.fromJson(json['urlType'] as String),
    );

Map<String, dynamic> _$$BirdwatchEntityRefImplToJson(
        _$BirdwatchEntityRefImpl instance) =>
    <String, dynamic>{
      'text': instance.text,
