...
_$UserImpl _$$UserImplFromJson(Map<String, dynamic> json) => _$UserImpl(
      ...
      highlightsInfo: UserHighlightsInfo.fromJson(
      ...
      legacyExtendedProfile: UserLegacyExtendedProfile.fromJson(
          json['legacy_extended_profile'] as Map<String, dynamic>),
      premiumGiftingEligible: json['premium_gifting_eligible'] as bool,
      professional: UserProfessional.fromJson(
          json['professional'] as Map<String, dynamic>),
      profileImageShape:
          UserProfileImageShape.fromJson(json['profile_image_shape'] as String),
