...
_$CommunityPinActionResultImpl _$$CommunityPinActionResultImplFromJson(
        Map<String, dynamic> json) =>
    _$CommunityPinActionResultImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
    );

Map<String, dynamic> _$$CommunityPinActionResultImplToJson(
        _$CommunityPinActionResultImpl instance) =>
    <String, dynamic>{
