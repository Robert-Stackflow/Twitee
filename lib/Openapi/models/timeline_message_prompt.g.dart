...
_$TimelineMessagePromptImpl _$$TimelineMessagePromptImplFromJson(
        Map<String, dynamic> json) =>
    _$TimelineMessagePromptImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
    );

Map<String, dynamic> _$$TimelineMessagePromptImplToJson(
        _$TimelineMessagePromptImpl instance) =>
    <String, dynamic>{
