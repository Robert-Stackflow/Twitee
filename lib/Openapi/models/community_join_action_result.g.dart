...
_$CommunityJoinActionResultImpl _$$CommunityJoinActionResultImplFromJson(
        Map<String, dynamic> json) =>
    _$CommunityJoinActionResultImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
    );

Map<String, dynamic> _$$CommunityJoinActionResultImplToJson(
        _$CommunityJoinActionResultImpl instance) =>
    <String, dynamic>{
