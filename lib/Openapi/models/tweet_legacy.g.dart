...
TweetLegacy _$TweetLegacyFromJson(Map<String, dynamic> json) => TweetLegacy(
      ...
      limitedActions: json['limited_actions'] == null
          ? null
          : TweetLegacyLimitedActions.fromJson(
              json['limited_actions'] as String),
      place: json['place'],
      ...
      selfThread: json['self_thread'] == null
          ? null
