...
_$CommunityJoinRequestsResultImpl _$$CommunityJoinRequestsResultImplFromJson(
        Map<String, dynamic> json) =>
    _$CommunityJoinRequestsResultImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
    );

Map<String, dynamic> _$$CommunityJoinRequestsResultImplToJson(
        _$CommunityJoinRequestsResultImpl instance) =>
    <String, dynamic>{
