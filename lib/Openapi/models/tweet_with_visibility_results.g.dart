...
_$TweetWithVisibilityResultsImpl _$$TweetWithVisibilityResultsImplFromJson(
        Map<String, dynamic> json) =>
    _$TweetWithVisibilityResultsImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
      limitedActionResults: json['limitedActionResults'],
      mediaVisibilityResults: MediaVisibilityResults.fromJson(
          json['mediaVisibilityResults'] as Map<String, dynamic>),
      tweet: Tweet.fromJson(json['tweet'] as Map<String, dynamic>),
      tweetInterstitial: TweetInterstitial.fromJson(
          json['tweetInterstitial'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$TweetWithVisibilityResultsImplToJson(
        _$TweetWithVisibilityResultsImpl instance) =>
    <String, dynamic>{
