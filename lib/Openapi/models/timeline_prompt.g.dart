...
_$TimelinePromptImpl _$$TimelinePromptImplFromJson(Map<String, dynamic> json) =>
    _$TimelinePromptImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
    );

Map<String, dynamic> _$$TimelinePromptImplToJson(
        _$TimelinePromptImpl instance) =>
    <String, dynamic>{
