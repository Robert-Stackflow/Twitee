...
_$TweetTombstoneImpl _$$TweetTombstoneImplFromJson(Map<String, dynamic> json) =>
    _$TweetTombstoneImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
    );

Map<String, dynamic> _$$TweetTombstoneImplToJson(
        _$TweetTombstoneImpl instance) =>
    <String, dynamic>{
