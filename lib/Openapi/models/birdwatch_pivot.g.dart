...
_$BirdwatchPivotImpl _$$BirdwatchPivotImplFromJson(Map<String, dynamic> json) =>
    _$BirdwatchPivotImpl(
      callToAction: BirdwatchPivotCallToAction.fromJson(
...
Map<String, dynamic> _$$BirdwatchPivotImplToJson(
        _$BirdwatchPivotImpl instance) =>
    <String, dynamic>{
