...
_$TweetInterstitialImpl _$$TweetInterstitialImplFromJson(
        Map<String, dynamic> json) =>
    _$TweetInterstitialImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
      displayType:
          TweetInterstitialDisplayType.fromJson(json['displayType'] as String),
      revealText: TweetInterstitialRevealText.fromJson(
          json['revealText'] as Map<String, dynamic>),
      text:
          TweetInterstitialText.fromJson(json['text'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$TweetInterstitialImplToJson(
        _$TweetInterstitialImpl instance) =>
    <String, dynamic>{
      '__typename': _$TypeNameEnumMap[instance.privateTypename]!,
      'displayType':
          _$TweetInterstitialDisplayTypeEnumMap[instance.displayType]!,
      'revealText': instance.revealText,
      'text': instance.text,
    };
...
const _$TweetInterstitialDisplayTypeEnumMap = {
  TweetInterstitialDisplayType.nonCompliant: 'NonCompliant',
  TweetInterstitialDisplayType.$unknown: r'$unknown',
};
