...
_$TweetUnavailableImpl _$$TweetUnavailableImplFromJson(
        Map<String, dynamic> json) =>
    _$TweetUnavailableImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
      reason: json['reason'] as String,
    );

Map<String, dynamic> _$$TweetUnavailableImplToJson(
        _$TweetUnavailableImpl instance) =>
    <String, dynamic>{
