...
_$FollowResponseResultImpl _$$FollowResponseResultImplFromJson(
        Map<String, dynamic> json) =>
    _$FollowResponseResultImpl(
      privateTypename: TypeName.fromJson(json['__typename'] as String),
      timeline:
          FollowTimeline.fromJson(json['timeline'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$FollowResponseResultImplToJson(
        _$FollowResponseResultImpl instance) =>
    <String, dynamic>{
