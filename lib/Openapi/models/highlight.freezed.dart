...
/// @nodoc
mixin _$Highlight {
  List<TextHighlight> get textHighlights => throw _privateConstructorUsedError;
...
abstract class $HighlightCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<TextHighlight> textHighlights});
}
...
class _$HighlightCopyWithImpl<$Res, $Val extends Highlight>
  ...
  @override
  $Res call({
    Object? textHighlights = null,
  }) {
    return _then(_value.copyWith(
      textHighlights: null == textHighlights
          ? _value.textHighlights
          : textHighlights // ignore: cast_nullable_to_non_nullable
              as List<TextHighlight>,
    ) as $Val);
  }
}
...
class _$HighlightImpl implements _Highlight {
  const _$HighlightImpl({required final List<TextHighlight> textHighlights})
      : _textHighlights = textHighlights;

  factory _$HighlightImpl.fromJson(Map<String, dynamic> json) =>
      _$$HighlightImplFromJson(json);

  final List<TextHighlight> _textHighlights;
  @override
  List<TextHighlight> get textHighlights {
    if (_textHighlights is EqualUnmodifiableListView) return _textHighlights;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_textHighlights);
  }

  @override
  String toString() {
    return 'Highlight(textHighlights: $textHighlights)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._textHighlights, _textHighlights));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_textHighlights));
...
abstract class _Highlight implements Highlight {
  const factory _Highlight(
      {required final List<TextHighlight> textHighlights}) = _$HighlightImpl;
